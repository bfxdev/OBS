...
function script_description()
  return [[<center><h2>BFX Halftone</h2></center>
  <p>This Lua script adds a video filter named <it>BFX Halftone</it>. The filter can be added
...
source_info = {}
source_info.id = 'filter-bfx-halftone'          -- Unique string identifier of the source type
...
source_info.create = function(settings, source)
  ...
  data.params.number_of_color_levels = obs.gs_effect_get_param_by_name(data.effect,
...
source_info.get_properties = function(data)
  ...
  obs.obs_properties_add_button(gprops, "pattern_reset", "Reset pattern texture",
    function(properties, property)
      obs.obs_data_set_string(data.settings, "pattern_path", ""); data.pattern = nil;
      set_properties_visibility(properties, property, data.settings); return true;
    end)
  ...
  obs.obs_properties_add_button(gprops, "palette_reset", "Reset palette texture",
    function(properties, property)
